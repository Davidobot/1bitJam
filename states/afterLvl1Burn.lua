...
function state:load()
    ...
    text = {
        ...
        {s = "YOUR OPPONENT BURNT TO A CRISP", f = font20, y = 0, ty = 20},
        {s = "YOU CANNOT WIN THE RACE", f = font20, y = 0, ty = 50},
    }
    ...
    buttons = {
        quit = {
            ...
            onClick = function()
                cur_level = 1
                lovelyMoon.switchState("afterLvl1Burn", "map")
            end
        },
    }

    img = love.graphics.newImage("gfx/after1_burn.png")
end
...
function state:enable()
    ...
    flux.to(text[3], 1.2, {y = text[3].ty}):ease("backout"):delay(0.4)
end
